...
const descriptorSets = [
  ...
  { name: "Floran", pathFragment: "/humanoid/floran/hair", fileExpression: /(\d)+\.png/i, hairShades: ["f7e7b2", "d9c189", "a38d59", "735e3a"], accessoryShades: ["f32200", "dc1f00", "be1b00"]},
  ...
  { name: "Hylotl", pathFragment: "/humanoid/hylotl/hair", fileExpression: /(\d)+\.png/i, hairShades: ["f7e7b2", "d9c189", "a38d59", "735e3a"], accessoryShades: ["f32200", "dc1f00", "be1b00", "951500"]},
...
function createWigDescriptor(descriptorSet, file) {
  return {
    ...
    accessoryShades: descriptorSet.accessoryShades,
    iconSource: ""
  }
}
